...
//		var symbolheight:Number;
		...
		private var processChildren:ArrayCollection;
		...
		public function AbstractFigure()
		{
			...
			processChildren = new ArrayCollection();
			
		}
		
		//added by ty 20130703
		public function addProcessChildren(operator:IFigure):void
		{
			processChildren.addItem(operator);
		}
		
		public function resetProcessChilren():void
		{
			processChildren.removeAll();
		}
		...
		public function getProcessChildren():ArrayCollection
		{
